...
ba_dates <- ba_dates %>% mutate(DateTime = force_tz(DateTime, tzone = "America/Chicago"))
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_start_time: 12.042 0.171 2148.408 0.003 0
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 12.443 0.171 2148.808 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 12.666 0.171 2149.03 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 12.723 0.171 2149.087 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 13.055 0.172 2149.418 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 13.583 0.172 2149.946 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
<tbody>
	<tr><td>2013</td><td>12  </td></tr>
	<tr><td>2014</td><td>24  </td></tr>
	<tr><td>2015</td><td> 8  </td></tr>
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 13.636 0.172 2149.994 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 14.039 0.172 2150.397 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
ba_dates <- ba_dates %>% mutate(zero = if_else(res == 0, TRUE, FALSE))
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 14.548 0.172 2150.905 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
...
```
    ...
    <ProjectReporter>
      ...
      Public:
        ...
        current_expectations: environment
        current_file: some name
        current_start_time: 14.623 0.172 2150.979 0.003 0
        dump_test: function (test) 
        end_context: function (context) 
        end_reporter: function () 
        end_test: function (context, test) 
