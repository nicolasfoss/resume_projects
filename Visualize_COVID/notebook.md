...
confirmed_cases_worldwide <- read_csv(file = "datasets/confirmed_cases_worldwide.csv")
...
confirmed_cases_china_vs_world <- read_csv(file = "datasets/confirmed_cases_china_vs_world.csv")
...
confirmed_cases_top7_outside_china <- read_csv(file = "datasets/confirmed_cases_top7_outside_china.csv")
